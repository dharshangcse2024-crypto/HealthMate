...
function AppContent() {
  ...
  return (
    <div className="app-layout relative min-h-screen">
      ...
      <div className="fixed top-0 left-0 w-full min-h-screen bg-gradient-to-br from-[#D97706] via-[#B45309] to-[#FCD34D] z-0 opacity-90 pointer-events-none animate-gradient"></div>
