...
function AppContent() {
  ...
  return (
    <div className="app-layout relative min-h-screen">
      ...
      <div className="fixed top-0 left-0 w-full min-h-screen bg-gradient-to-br from-purple-500 via-fuchsia-400 to-cyan-400 z-0 opacity-90 pointer-events-none animate-gradient"></div>
